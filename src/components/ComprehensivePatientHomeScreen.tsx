...
declare module "next-auth" {
  interface Session {
    error?: string; // Add the error property to the session
  }
}
...
export default function ComprehensivePatientHomeScreen() {
  ...
  else if(session)
  {
    return (
      ...
      <div className="container mx-auto  bg-white">
        ...
        <main className="p-4">
                          <h3 className="text-lg font-semibold mb-2"> Welcome, John Doe</h3>
          <Card className="mb-4">
            <CardHeader>
